...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self) -> None:
        ...
        self.image = pygame.image.load("smb_smallmario.png")
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load("spaceinvaders.png")
...
def main() -> None:
    ...
    instructions = ("Collect all the blocks to win! Don't touch the goombas!")
